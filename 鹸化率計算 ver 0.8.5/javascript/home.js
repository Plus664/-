...
function calc_result(){
    ...
    const oil_name1 = "・ " + oil_amount_info[0] + " " + Number(oil_amount1.value) + "g";
    const oil_name2 = "・ " + oil_amount_info[1] + " " + Number(oil_amount2.value) + "g";
    const oil_name3 = "・ " + oil_amount_info[2] + " " + Number(oil_amount3.value) + "g";
    const oil_name4 = "・ " + oil_amount_info[3] + " " + Number(oil_amount4.value) + "g";
    const oil_name5 = "・ " + oil_amount_info[4] + " " + Number(oil_amount5.value) + "g";
    const oil_name6 = "・ " + oil_amount_info[5] + " " + Number(oil_amount6.value) + "g";
    const oil_name7 = "・ " + oil_amount_info[6] + " " + Number(oil_amount7.value) + "g";
    const oil_name8 = "・ " + oil_amount_info[7] + " " + Number(oil_amount8.value) + "g";
    const oil_name9 = "・ " + oil_amount_info[8] + " " + Number(oil_amount9.value) + "g";
    const oil_name10 = "・ " + oil_amount_info[9] + " " + Number(oil_amount10.value) + "g";
    ...
    const additional_info = get_additional_info();
...
//    const oil_amounts = [amount1, amount2, amount3, amount4, amount5, amount6, amount7, amount8, amount9, amount10];
//    sessionStorage.setItem("oilAmounts", oil_amounts.toString());
