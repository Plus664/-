...
const display_oils = () => {
    ...
    if(oil_name1 == "・  0g"){
        ...
        oil_amount_result1.textContent = "・  0g";
    ...
    if(oil_name2 == "・  0g"){
        ...
        oil_amount_result2.textContent = "・  0g";
    ...
    if(oil_name3 == "・  0g"){
        ...
        oil_amount_result3.textContent = "・  0g";
    ...
    if(oil_name4 == "・  0g"){
        ...
        oil_amount_result4.textContent = "・  0g";
    ...
    if(oil_name5 == "・  0g"){
        ...
        oil_amount_result5.textContent = "・  0g";
    ...
    if(oil_name6 == "・  0g"){
        ...
        oil_amount_result6.textContent = "・  0g";
    ...
    if(oil_name7 == "・  0g"){
        ...
        oil_amount_result7.textContent = "・  0g";
    ...
    if(oil_name8 == "・  0g"){
        ...
        oil_amount_result8.textContent = "・  0g";
    ...
    if(oil_name9 == "・  0g"){
        ...
        oil_amount_result9.textContent = "・  0g";
    ...
    if(oil_name10 == "・  0g"){
        ...
        oil_amount_result10.textContent = "・  0g";
...
function pres_result(){
    ...
    //const newId = preserved_recipes.length > 0 ? Math.max(...preserved_recipes.map(r => r.id)) + 1 : 1;
